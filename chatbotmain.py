...
conversations= [
    [
        r"Am (.*)",
        ['Hey %1 ! How may I help you today!!'],
    ],
    [
        r"hi|hey|hello",
    ...
    [
        r"(.*) installments|installments (.*)|installments",
    ...
    [
        r"(.*) facilities available in hostel |facilities available in hostel(.*)| facilities available in hostel",
    ...
    [
        r"(.*) thanks|thanks|thanks (.*)| thank you (.*)|thank you",
        ["Welcome! is there any you need to know ?... Feel free to ask!"]
